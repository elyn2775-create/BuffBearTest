...
const quizData = [
    ...
    { modulePart: "PART 6", moduleTitle: "职业成长", question: "12. 你希望获得的核心成长是？", options: [{ text: "A. 沟通和影响力", scores: { hr: 3, sales: 3, supply: 1, brand: 2, finance: 1, it: 1 } }, { text: "B. 专业与技术能力", scores: { hr: 1, sales: 1, supply: 2, brand: 1, finance: 3, it: 3 } }, { text: "C. 创意与策划能力", scores: { hr: 1, sales: 2, supply: 1, brand: 3, finance: 1, it: 1 } }, { text: "D. 统筹与执行能力", scores: { hr: 2, sales: 2, supply: 3, brand: 2, finance: 2, it: 2 } }] }
];
const resultsData = {
    caiwu: "caiwu.jpg",
